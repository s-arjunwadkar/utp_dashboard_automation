...
CREATE OR REPLACE SECURE VIEW GOLD.SECURE_V_DELTA_REPORT_OUTPUT_GOLD
...
GRANT SELECT ON VIEW UTP_DASHBOARD.GOLD.SECURE_V_DELTA_REPORT_OUTPUT_GOLD TO SHARE TTI_UTP_DASHBOARD_SHARE;