...
targets_by_district_4r_12_10_11s AS (
    SELECT
        category,
        district_mpo_division,
        fy,
...
target_totals_4r_12_10_11s AS (
    SELECT
        category,
        fy,
        SUM(total_targets) AS new_targets_yearly
    FROM targets_by_district_4r_12_10_11s
...
adjust_4r_12_10_11s AS (
    SELECT
        ...
        m.carryovers
    FROM targets_by_district_4r_12_10_11s AS m
    LEFT JOIN target_totals_4r_12_10_11s AS s
