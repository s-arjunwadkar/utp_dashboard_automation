...
change_orders_final AS (
    SELECT
        ...
        CASE
            ...
            WHEN CATEGORY = '12' AND METRIC_NAME ILIKE '12_Clear%' THEN '12CL'
            WHEN CATEGORY = '12' AND (METRIC_NAME ILIKE '12_TTC' OR NOT METRIC_NAME ILIKE '12_Clear%') THEN '12TTC'
            WHEN CATEGORY = '12' AND NOT METRIC_NAME ILIKE ANY ('12_Clear%', '12_TTC') THEN '12OTHER'
            ELSE CATEGORY
        END AS CATEGORY_NEW,
        METRIC_NAME,
        CASE
